...
const NOTICIAS = [
  {
    id: 1,
    tipo: 'Logro',
    titulo: 'Clínica Integral para la Mujer ha atendido a más de 500 embarazadas durante 2026',
    detalle: 'Atención integral y acompañamiento permanente',
    fecha: 'Actualizado al 26 Ago 2026',
    icono: 'favorite',
    color: '#541e8c',
    imagen: '/noticias/clinica de la mujer.jpeg',
  },
  {
    id: 2,
    tipo: 'Logro',
    titulo: 'Clínica Municipal Capitán José Pérez Fernández graduó a 32 lactantes',
    detalle: 'Compromiso con la primera infancia',
    fecha: 'Actualizado al 26 Ago 2026',
    icono: 'emoji_events',
    color: '#059669',
    imagen: '/noticias/clinica municipal.jpeg',
  },
  {
    id: 3,
    tipo: 'Atención',
    titulo: 'Activos puntos de atención inmediata ante el fenómeno del Súper Niño',
    detalle: 'Respuesta rápida en toda la red municipal',
    fecha: 'Actualizado al 26 Ago 2026',
    icono: 'medical_services',
    color: '#0d9488',
    imagen: '/noticias/supernino.jpeg',
  },
];
