...
const RESPUESTAS = {
  ...
  'Centros de salud aliados y horarios': 'Actualmente contamos con <strong>6 centros de salud</strong> en la red municipal: CITAB (Clínica de los Trabajadores, Lun-Vie 7AM-6PM), Clínica de la Mujer (Lun-Sáb 7AM-5PM), Clínica del Niño (Lun-Sáb 7AM-6PM), Clínica Municipal José Pérez Fernández (Lun-Vie 7AM-5PM), Jornadas de Salud (fines de semana, calendario público) y el Centro Oncológico (Lun-Vie 7AM-5PM). Todos comparten el mismo historial clínico y sistema de referencia.',
